...
_EN = {
    ...
    "regularization":      u"Regularization (\u03bb):",
    ...
    "quat_group_start_value_tip":
        u"Output start index \u2014 group spans 4 outputs (S, S+1, S+2, S+3)",
    "list_editor_add":             "+",
    ...
    "msg_import_poses_failed":         u"Pose import failed. See Script Editor for details (likely cause: driver/driven dimension mismatch \u2014 connect the same number of attrs as the source rig before importing).",
    ...
    "live_edit_warn_no_node":          u"no current node \u2014 pick an RBF node first",
    ...
    "angle_disabled_for_encoding_tip":
        ...
        u"this setting (see addendum \u00a7M_P0_OUTPUT_EXPMAP_FIX).",
    ...
    "title_mirror_multi_source":       u"Mirror \u2014 Multi-source node",
    "summary_mirror_multi_source":
        ...
        u"mirror remains deferred to M_B24c2 (addendum \u00a7M_B24c2-stub) "
        "and is blocked at the engine entry. Continue?",
    # -- M3.5: Pose Profiler + ToolsSection (spillover sec.3) --
    "section_tools":                   "Tools",
    ...
    "msg_batch_apply_confirm":
        ...
        u"This is multi-tab destructive \u2014 confirm before "
        "proceeding.",
    ...
    "msg_batch_clear_confirm":
        ...
        u"when empty. This is multi-tab destructive \u2014 confirm "
        "before proceeding.",
