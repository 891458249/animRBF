# -*- coding: utf-8 -*-
u"""DriverSourceListEditor \u2014 multi-source driver list editor (M_B24b1).
...
# driverSource_encoding (M_B24a1 sec.3.2).
_ENCODING_LABELS = [
    ("Raw",        0),
    ("Quaternion", 1),
    ("BendRoll",   2),
...
class DriverSourceListEditor(_OrderedListEditorBase):
    u"""Editable ordered list of :class:`DriverSource` entries.
    ...
    def set_sources(self, sources):
        u"""Programmatic rebuild from list[DriverSource]. Suspends emit
