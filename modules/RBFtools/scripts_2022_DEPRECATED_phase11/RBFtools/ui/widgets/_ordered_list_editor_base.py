...
class _OrderedListEditorBase(QtWidgets.QWidget):
    ...
    def _build(self):
        ...
        # only per addendum sec.M2.4b refinement 2.
    ...
    def set_values(self, values):
        u"""Programmatically rebuild rows from *values*.
    ...
    def _rebuild_row(self, row_idx, value):
        u"""Destroy-and-rebuild pattern (addendum \u00a7M2.4b Q1b)."""
    ...
    def _on_any_row_changed(self):
        u"""Single collector \u2014 every inline widget's value-change signal
