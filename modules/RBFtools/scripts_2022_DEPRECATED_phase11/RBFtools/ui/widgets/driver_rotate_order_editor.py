# -*- coding: utf-8 -*-
u"""DriverRotateOrderEditor \u2014 driver-tab-synced rotate-order editor
...
class DriverRotateOrderEditor(QtWidgets.QWidget):
    ...
    def set_label(self, text):
        ...
        # instead of ``str(text or "")``. Under py2, ``str(u"??")``
    ...
    def retranslate(self):
        u"""Re-render row labels (driver name + idx template) on
