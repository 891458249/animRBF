...
class RBFSection(CollapsibleFrame):
    ...
    def _build(self):
        ...
        # M2.4a: M1.4 regularization (Tikhonov lambda).
    ...
    def load(self, data):
        ...
        # the controller (addendum sec.M2.4b refinement / contract).
    ...
    def force_mode_visibility(self, idx):
        u"""M_P0_RBF_MODE_UI_RESYNC (2026-05-10): authoritative resync
    ...
    def set_driver_sources_for_rotate_order(self, names):
        u"""M_ROTORDER_UI_REFACTOR (2026-04-29): public entry-point
    ...
    def set_rotate_order_values(self, values):
        u"""M_P1_ENC_COMBO_FIX (2026-04-29): narrow public entry-point
    ...
    def _update_encoding_visibility(self, idx):
        u"""Single source of truth for the rotateOrder editor visibility.
