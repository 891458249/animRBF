# -*- coding: utf-8 -*-
u"""TabbedSourceEditor \u2014 strict-spec rewrite (2026-04-27 user directive).
...
class _TabbedSourceEditorBase(QtWidgets.QGroupBox):
    u"""One Driver/Driven panel - QGroupBox-wrapped inner QTabWidget +
    ...
    def _build(self):
        ...
        # old default, a multi-tab rig (e.g. 3 driver tabs x 10 driven
        ...
        # x batch = 1 tab swept, identical to 1 active tab x no-batch).
    ...
    def tab_targets(self):
        u"""Return a list of ``(node, own_selected_attrs)`` for every
    ...
    def blueprint_attrs(self):
        u"""The attrs of the currently-active tab's QListWidget
