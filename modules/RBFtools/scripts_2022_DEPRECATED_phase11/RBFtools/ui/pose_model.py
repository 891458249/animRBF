...
class PoseTableModel(QtCore.QAbstractTableModel):
    ...
    def data(self, index, role=QtCore.Qt.DisplayRole):
        u"""Return cell data for the given *index* and *role*.
    ...
    def update_pose_radius(self, row, new_radius):
        u"""Commit 3 (M_PER_POSE_SIGMA): set the per-pose \u03c3 on an
    ...
    def find_row_by_pose_index(self, pose_idx):
        u"""Reverse-lookup: pose index \u2192 model row.  Returns -1 if absent."""
